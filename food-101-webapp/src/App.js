...
class App extends Component {
  ...
  constructor() {
    ...
    this.state = {
      ...
      topK: null,
      hasWebgl,
      url: null //'http://www.rawtillwhenever.com/wp-content/uploads/2015/09/vegan-tempura-sushi-2.png'
    };
  }
      ...
      <div id="App" className="App">
        ...
        <div className='interactive'>
          ...
          <p>
            ...
            <br/><br/>
            <input type="file" onChange={this.uploadSelectedHandler}/>
